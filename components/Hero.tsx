    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6 md:px-10">
        ...
        <div className="mt-9 flex flex-wrap items-center gap-4">
          <a
            href="#contact"
            className="focus-ring inline-flex items-center gap-2 rounded-full bg-mint px-6 py-3 text-sm font-semibold text-ink transition-transform hover:scale-[1.03]"
          >
